      ...
      .select(
        `*,
          ...
          contained_batches:product_batch_ingredients!product_batch_ingredients_product_batch_id_fkey(id, used_amount, 
            commodity_batch:commodity_batches(external_id, commodity:commodities(name, unit, id)), 
            product_batch:product_batches!product_ingredient_batch_id(external_id, product:products(name, unit, id)))
        `
      )
