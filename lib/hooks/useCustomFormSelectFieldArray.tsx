...
import CustomFormSelect from "@/components/forms/CustomFormSelect";
...
const useCustomFormSelectFieldArray = <T extends FieldValues>({
  name,
  objectField,
  form,
  commonItems,
  ...
  return { append, remove, CustomFormSelectFieldArray };
};
export default useCustomFormSelectFieldArray;
